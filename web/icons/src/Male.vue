<template>
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M41.9517 15.0483V6.04834H32.9517" stroke="currentColor" stroke-width="4" stroke-linecap="round"
        ...
        <path d="M30.0002 17.9999L39.9517 8.04838" stroke="currentColor" stroke-width="4" stroke-linecap="round"
            stroke-linejoin="round" />
    </svg>
</template>